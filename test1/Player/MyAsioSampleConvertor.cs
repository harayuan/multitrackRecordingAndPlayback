        ...
        public static SampleConvertor SelectSampleConvertor(WaveFormat waveFormat, AsioSampleType asioType)
        {
            ...
            switch (asioType)
            {
                ...
                case AsioSampleType.Int24LSB:
                    ...
                    {
                        case 16:
                            throw new ArgumentException($"Converting {waveFormat.BitsPerSample} bit to Int 24 is not a supported conversion");
                        case 32:
                ...
                case AsioSampleType.Float32LSB:
                    ...
                    {
                        case 16:
                            throw new ArgumentException($"Converting {waveFormat.BitsPerSample} bit to Float 32 is not a supported conversion");
                        case 32:
