...
namespace Automation.Player
{
    ...
    public class MyAsioOut : IWavePlayer
    {
        ...
        /// </summary>
        public event EventHandler<MyAsioAudioAvailableEventArgs> AudioAvailable;
        ...
        public void InitRecordAndPlayback(IWaveProvider waveProvider, int recordChannels)
        {
            if (isInitialized)
            {
        ...
        //ASIO does not support changing volume
        public float Volume
        {
            get
            {
