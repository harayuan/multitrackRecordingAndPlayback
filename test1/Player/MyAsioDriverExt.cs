...
{ 
    ...
    /// </summary>
    public class MyAsioDriverExt
    {
        private readonly MyAsioDriver driver;
        private AsioCallbacks callbacks;
        private AsioDriverCapability capability;
        private MyAsioBufferInfo[] bufferInfos;
        ...
        public MyAsioDriver Driver => driver;
        ...
        public int CreateBuffers(int numberOfOutputChannels, int numberOfInputChannels, bool useMaxBufferSize)
        {
            ...
            bufferInfos = new MyAsioBufferInfo[nbTotalChannels];
            ...
            unsafe
            {
                fixed (MyAsioBufferInfo* infos = &bufferInfos[0])
                {
